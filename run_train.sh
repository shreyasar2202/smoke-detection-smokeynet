...
python3.9 src/main.py \
    ...
    --model-type-list "RawToTile_MobileNetFPN_Flow" "TileToTile_LSTM_Flow" "TileToTileImage_SpatialViT" \
    --omit-list "omit_no_xml" "omit_no_contour" \
    --error-as-eval-loss \
    --use-image-preds \
    --batch-size 1 \
...
python3.9 src/main.py \
    --experiment-name "Final_EfficientNet_LSTM_SpatialViT_Mog" \
    --model-type-list "RawToTile_EfficientNet_Flow" "TileToTile_LSTM_Flow" "TileToTileImage_SpatialViT" \
    --omit-list "omit_no_xml" "omit_no_contour" \
    --error-as-eval-loss \
    --use-image-preds \
    --batch-size 1 \
