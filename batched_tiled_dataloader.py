...
class BatchedTiledDataModule(pl.LightningDataModule):
    def __init__(self, 
                 ...
                 omit_images_path='/userdata/kerasData/data/new_data/batched_tiled_data/omit_images.npy',  
        ...
        Args:
            ...
            - omit_images_path (str): path to .npy file of images to omit because of mislabeling
        ...
        self.omit_images = np.load(omit_images_path)
    ...
    def setup(self, stage=None):
        ...
        if self.train_split_path is None or self.val_split_path is None or self.test_split_path is None:
            self.train_split = [image for image in self.metadata['fire_to_images'][fire] \
                                if image not in self.omit_images \
                                for fire in train_fires]
